...
var populateDB = function() {
	...
	db.collection('fart', function(err, collection) {
...
db.open(function(err, db) {
	if(!err) {
		console.log("Connected to 'fart' database");
		db.collection('fart', {strict:true}, function(err, collection) {
		if (err) {
			console.log("The 'fart' collection doesn't exist. Creating it with sample data...");
			populateDB();
			}
		});
	}
